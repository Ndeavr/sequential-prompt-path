...
const VARIANTS = [
  ...
  (name: string) => `Bonjour ${name}. Clara (IA d'UNPRO) a préqualifié un projet dans votre secteur. Jusqu'à 5 rendez-vous garantis dès 350$ : https://unpro.ca/entrepreneur/garantie`,
...
Deno.serve(async (req) => {
  ...
  const __safe = await validateOnlyResponse(req, cors, __caller, "emergency-sms-blast");
