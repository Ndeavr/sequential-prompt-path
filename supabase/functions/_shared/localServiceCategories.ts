 ...
 *  - le miroir serveur vit dans le module client `src/lib/localServices/categories.ts`
...
export const LOCAL_SERVICE_CATEGORIES: LocalServiceCategory[] = [
  ...
  { slug: "entretien-menager", name_fr: "Entretien ménager", keywords: ["entretien menager", "menage", "femme de menage", "nettoyage residentiel", "service de menage", "nettoyage de cuisine", "nettoyage de cuisines", "nettoyage de sous sol", "nettoyage de sous sols", "nettoyage de garage", "basement cleaning", "kitchen cleaning", "house cleaning", "cleaning service", "cleaning services"] },
  ...
  { slug: "nettoyage-planchers", name_fr: "Nettoyage de planchers, céramique et coulis", keywords: ["nettoyage de planchers", "nettoyage de plancher", "lavage de planchers", "lavage de plancher", "lavage de ceramique", "nettoyage ceramique", "polissage de planchers", "nettoyage de ceramique", "nettoyage de coulis", "nettoyage de tuiles", "decapage de planchers", "floor cleaning", "tile cleaning", "tile and grout cleaning", "grout cleaning"] },
