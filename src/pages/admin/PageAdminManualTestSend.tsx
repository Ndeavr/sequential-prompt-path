...
export default function PageAdminManualTestSend() {
  ...
  const [body, setBody] = useState("Ceci est un test live envoyé depuis clara@mail.unpro.ca.");
  ...
  const sendTest = useMutation({
    mutationFn: async () => {
      ...
      if (mailbox.data?.mailbox_status !== "active") throw new Error("Mailbox clara@mail.unpro.ca inactive");
