  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Analyse gratuite en 30 secondes. Découvrez comment ChatGPT et Gemini perçoivent votre entreprise et recevez vos premiers rendez-vous qualifiés." />
      </Helmet>
