 ...
 * AI recommendation + plan cards + revenue projection.
 */
  ...
  return (
    <FunnelLayout currentStep="plan_recommendation" showProgress={false}>
      <div className="max-w-lg mx-auto">
        {/* AI recommendation */}
        <motion.div
          className="rounded-xl border border-primary/30 bg-primary/5 p-4 mb-6 flex items-start gap-3"
        ...
        >
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-1">
              Basé sur vos zones de service, vos services et la demande locale.
            </p>
          </div>
        </motion.div>
