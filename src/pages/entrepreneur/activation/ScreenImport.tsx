 ...
 * Animated progress with polling.
 */
...
export default function ScreenImport() {
  ...
  // Simulate progressive import animation
  const advanceStep = useCallback(() => {
    ...
    // Mark running → completed after delay
    setTimeout(() => {
      setSteps(prev => prev.map((s, i) => {
  ...
  useEffect(() => {
    // Start enrichment edge function
      ...
      <div className="px-4 pt-6 pb-2 flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-xs text-muted-foreground">
            {state.business_name || "Votre entreprise"}
          </p>
        </div>
      </div>
