 ...
 * Google Calendar OAuth + simple availability.
 */
...
export default function ScreenCalendar() {
  ...
  const handleConnect = () => {
    // In production, this would trigger Google Calendar OAuth
    setConnected(true);
    ...
    <FunnelLayout currentStep="assets_studio" showProgress={false}>
      ...
      >
        ...
        <p className="text-sm text-muted-foreground mb-6">
          Recevez des rendez-vous directement dans votre agenda.
        </p>
        ...
        <div className="space-y-3">
          <Button
            ...
            onClick={() => navigate("/entrepreneur/activer/plan")}
          >
