...
const ALLOWED_TRANSITIONS: Record<LockedVoiceState, LockedVoiceState[]> = {
  ...
  requesting_permission: ["opening_session", "error_fatal", "closing"],
  opening_session: ["stabilizing", "error_recoverable", "error_fatal", "closing"],
  stabilizing: ["session_ready", "error_recoverable", "error_fatal"],
  session_ready: ["listening", "error_recoverable", "closing"],
  listening: ["capturing_voice", "processing_stt", "error_recoverable", "closing"],
  capturing_voice: ["processing_stt", "listening", "error_recoverable", "closing"],
  processing_stt: ["processing_response", "listening", "error_recoverable", "closing"],
  processing_response: ["speaking", "listening", "error_recoverable", "closing"],
  speaking: ["awaiting_user", "listening", "error_recoverable", "closing"],
  awaiting_user: ["listening", "error_recoverable", "closing"],
  error_recoverable: ["listening", "opening_session", "closing", "error_fatal"],
