...
export function useContractorQuestionnaire() {
  ...
  useEffect(() => {
    ...
    setForm((prev) => ({
      ...
      emergency_service: contractor.emergency_service ?? prev.emergency_service,
