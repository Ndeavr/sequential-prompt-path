  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle at 50% 60%, hsl(212 100% 50% / 0.55), transparent 60%)",
        }}
      />
      {/* Reflection plate under sphere */}
      <div
        ...
        style={{
          ...
          height: 30,
          background:
            "radial-gradient(ellipse at center, hsl(212 100% 55% / 0.55), transparent 70%)",
          filter: "blur(8px)",
        }}
      />
      {/* Sphere */}
      <div
        className={`absolute inset-2 rounded-full ${breathing ? "animate-[orb-breathe_4s_ease-in-out_infinite]" : ""}`}
        style={{
          background: `
            radial-gradient(circle at 32% 28%, hsl(220 60% 22%) 0%, hsl(222 70% 12%) 28%, hsl(222 80% 6%) 55%, #02060d 100%),
            radial-gradient(circle at 70% 80%, hsl(212 100% 25% / 0.6), transparent 50%)
          `,
          boxShadow: `
            inset 0 -30px 60px hsl(212 100% 50% / 0.35),
            inset 0 0 0 1px hsl(212 100% 60% / 0.45),
            0 30px 70px -10px hsl(212 100% 45% / 0.5),
            0 0 90px hsl(212 100% 55% / 0.35)
          `,
        }}
      >
        {/* Top reflection */}
        <div
          className="absolute top-3 left-1/2 -translate-x-1/2 rounded-full opacity-70"
          style={{
            width: "55%",
            height: "22%",
            background:
        ...
        />
        {/* House icon top inner */}
        <svg
          viewBox="0 0 24 24"
          className="absolute left-1/2 -translate-x-1/2 top-[22%] w-12 h-12"
          fill="none"
          stroke="hsl(212 100% 65%)"
          strokeWidth="2.2"
          strokeLinecap="round"
          strokeLinejoin="round"
          style={{ filter: "drop-shadow(0 0 12px hsl(212 100% 60% / 0.7))" }}
          aria-hidden
        >
        ...
        {/* LED smiley eyes */}
        <div className="absolute left-1/2 -translate-x-1/2 top-[55%] flex gap-5">
          <span
            className="block w-3 h-7 rounded-full"
            style={{
              background:
                "linear-gradient(180deg, hsl(200 100% 80%), hsl(212 100% 55%))",
              boxShadow:
                "0 0 14px hsl(212 100% 60%), 0 0 28px hsl(212 100% 55% / 0.7)",
            }}
          />
          <span
            className="block w-3 h-7 rounded-full"
        ...
        {/* Active speaking pulse ring */}
        {state === "speaking" && (
          <span
            className="absolute inset-0 rounded-full"
            style={{
              boxShadow:
                "0 0 0 2px hsl(212 100% 60% / 0.6), 0 0 60px hsl(212 100% 55% / 0.6)",
              animation: "orb-pulse 1.4s ease-out infinite",
            }}
          />
        )}
      </div>
