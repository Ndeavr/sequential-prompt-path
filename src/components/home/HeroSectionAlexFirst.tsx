    ...
    <>
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center text-center w-full max-w-xl mx-auto px-5 pt-8 pb-24 gap-6 sm:gap-8">
          ...
          {/* ── Entrepreneur CTA — placée APRÈS les pills pour ne pas écraser la voix ── */}
          <button
            type="button"
            onClick={() => navigate("/contractor-ai-growth")}
            data-testid="entrepreneur-cta-chip"
            aria-label="Je suis un entrepreneur — découvrir UNPRO"
            className="group inline-flex items-center gap-2 px-5 py-3 mt-3 rounded-full text-sm sm:text-[15px] font-semibold text-white transition-all hover:scale-[1.03] active:scale-95"
            style={{
