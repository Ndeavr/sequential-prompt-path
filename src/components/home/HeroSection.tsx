...
import { Mic, Volume2, VolumeX, Loader2, Keyboard, Square, CheckCircle2, AlertTriangle } from "lucide-react";
              ...
              <AnimatePresence>
               ...
               {!voiceActive && (
                 <motion.div
                   ...
                   className="mt-6 mb-4 flex justify-center md:justify-start"
                 >
                   <Link to="/emergency" className="relative">
                     ...
                     />
                     <motion.div
                       className="relative flex items-center gap-2.5 rounded-2xl px-6 py-3.5 text-sm font-bold text-white"
                       style={{
