  ...
  return (
    <section className="relative min-h-[70vh] flex flex-col items-center justify-center px-4 text-center overflow-hidden">
      ...
      >
        ...
        <motion.div initial={{ scale: 0.95 }} animate={{ scale: 1 }} transition={{ delay: 0.3, type: "spring", stiffness: 200 }}>
          <Button size="lg" onClick={onVoiceStart} className="h-14 px-8 text-base font-semibold rounded-2xl gap-3 w-full sm:w-auto shadow-lg">
        ...
        <Button variant="ghost" onClick={onChatStart} className="text-sm text-muted-foreground hover:text-foreground">
          Continuer par chat →
        </Button>
