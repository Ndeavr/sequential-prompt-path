    ...
    <header className="sticky top-0 z-40 border-b border-border/30 bg-background/80 backdrop-blur-xl">
      <div className="mx-auto max-w-6xl px-4 h-14 flex items-center justify-between">
        ...
        <Link to="/" className="flex items-center gap-2 shrink-0 group">
          <img src={unproLogo} alt="UNPRO" className="h-10 w-10 rounded-lg object-contain" style={{ filter: "brightness(0) saturate(100%) invert(28%) sepia(92%) saturate(1800%) hue-rotate(213deg) brightness(101%) contrast(101%)" }} />
