...
import repDemoImg from "@/assets/rep-demo-aipp.webp";

const pills = [
  { icon: GraduationCap, label: "Étudiants bienvenus" },
  { icon: Clock, label: "Temps partiel OK" },
  { icon: MapPin, label: "Territoire exclusif" },
];
  ...
  return (
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden px-4 py-20">
      ...
      <div className="relative z-10 max-w-3xl mx-auto text-center space-y-8">
        ...
        >
          Tu aides les entrepreneurs à voir ce qu'ils ne voient pas.
        </motion.h1>
        ...
        >
          Rencontre des entrepreneurs. Crée leur profil IA en live.
          Encaisse des commissions récurrentes — sans cold call, sans bureau.
        </motion.p>
        ...
        >
          {pills.map((pill) => (
            <span
              key={pill.label}
              className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-muted text-sm text-muted-foreground border border-border/60"
            >
