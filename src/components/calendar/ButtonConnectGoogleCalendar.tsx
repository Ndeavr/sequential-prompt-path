/**
 * ButtonConnectGoogleCalendar — premium CTA for Google OAuth flow.
 */
...
export default function ButtonConnectGoogleCalendar({ surface, role, returnTo, className, label }: Props) {
  ...
  return (
    <Button
      onClick={handleClick}
      disabled={busy}
      className={`h-11 rounded-xl bg-white text-slate-900 hover:bg-white/90 font-semibold shadow-sm ${className ?? ""}`}
    >
      {busy ? (
