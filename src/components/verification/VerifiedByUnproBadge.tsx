...
export default function VerifiedByUnproBadge({ adminVerified, internalVerifiedScore, internalVerifiedAt, loading }: Props) {
  ...
  const formattedDate = internalVerifiedAt
    ? new Date(internalVerifiedAt).toLocaleDateString("fr-CA", { year: "numeric", month: "long", day: "numeric" })
    : null;
  ...
  return (
    ...
    >
      ...
      <div className="min-w-0">
        ...
        {internalVerifiedScore != null && (
          <p className="text-xs text-muted-foreground">
            Score interne vérifié : {internalVerifiedScore}/100
          </p>
        )}
        {formattedDate && (
