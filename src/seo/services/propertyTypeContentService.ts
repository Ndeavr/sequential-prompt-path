...
export function buildPropertyTypeCityPage(
  ...
  return {
    ...
    metaTitle: `${pt.nameFr} ${city.name} — Rendez-vous garanti | Entrepreneur vérifié | UNPRO`,
    metaDescription: `Trouvez un entrepreneur fiable pour votre ${pt.nameFr.toLowerCase()} à ${city.name}. Aucun spam, aucun comparatif inutile. Rendez-vous confirmé avec un professionnel qualifié.`,
    intro,
    localContext,
    topProblems: pt.topProblems,
...
export function buildPropertyTypeProblemPage(
  ...
  return {
    ...
    metaTitle: `${problem.nameFr} ${pt.nameFr} ${city.name} — Rendez-vous garanti | UNPRO`,
    metaDescription: `Trouvez un entrepreneur fiable pour ${problem.nameFr.toLowerCase()} (${pt.nameFr.toLowerCase()}) à ${city.name}. Rendez-vous confirmé avec un professionnel qualifié.`,
