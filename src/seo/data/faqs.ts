...
export const SEO_FAQS: SeoFaq[] = [
  ...
  { question: "Comment est établi le prix d'un débarras (junk removal) ?", answer: "Le prix dépend surtout du volume à enlever (souvent facturé en fraction de camion ou en verges cubes), du temps de chargement, de l'accès au bâtiment (étages, escaliers, ascenseur), de la distance de portage et du stationnement disponible. Envoyer des photos ou une courte vidéo permet d'obtenir un devis beaucoup plus fiable.", topics: ["debarras-junk-removal", "debarras", "demenagement"] },
  { question: "Quelle est la différence entre un débarras et l'enlèvement de débris de rénovation ?", answer: "Le débarras vise le contenu d'un espace : meubles, électroménagers, boîtes, objets volumineux d'un garage, d'un sous-sol ou d'un logement. Les débris de rénovation (gypse, bois, céramique, matériaux de démolition) demandent souvent un conteneur ou un service spécialisé, avec des conditions et des coûts différents. Précisez la nature des matières dès la demande.", topics: ["debarras-junk-removal", "debarras", "renovation"] },
  { question: "Qu'arrive-t-il aux objets ramassés lors d'un débarras ?", answer: "Selon le prestataire et la municipalité, une partie des objets peut être dirigée vers le recyclage, l'écocentre ou le don, et le reste vers l'élimination. Les filières et les matières acceptées varient : demandez au prestataire ce qu'il accepte et comment il dispose des matières avant de confirmer le rendez-vous.", topics: ["debarras-junk-removal", "debarras"] },
  { question: "Quelles informations préparer avant de demander un débarras ?", answer: "Préparez la liste ou des photos des objets, le volume approximatif, l'étage et le type d'accès, la présence d'un ascenseur ou d'escaliers, l'espace de stationnement, la date souhaitée et toute matière particulière (électroménagers, matelas, produits spéciaux). Ces éléments permettent une estimation juste et évitent les surprises sur place.", topics: ["debarras-junk-removal", "debarras", "demenagement"] },
  // ─── General ───
