  ...
  <BrowserRouter>
    ...
    <Suspense fallback={<LazyFallback />}>
      <Routes>
        ...
        <Route path="/admin/verified-contractors" element={<UniversalRouteGuard allowedRoles={["admin"]}><Suspense fallback={<LazyFallback />}><AdminVerifiedContractors /></Suspense></UniversalRouteGuard>} />
