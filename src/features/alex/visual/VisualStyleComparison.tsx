            ...
            <button
              ...
              className={`group relative text-left rounded-2xl overflow-hidden border-2 transition-all ${
                isPicked ? "border-primary ring-2 ring-primary/30"
                  : isRecommended ? "border-primary/60 shadow-[0_0_24px_-4px_hsl(var(--primary)/0.4)]"
                  : "border-border hover:border-primary/50"
              }`}
            >
              {isRecommended && !isPicked && (
                <span className="absolute top-2 left-2 z-10 text-[10px] font-bold uppercase tracking-wider px-2 py-0.5 rounded-full bg-primary text-primary-foreground flex items-center gap-1">
