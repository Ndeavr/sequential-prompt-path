...
export const DEFAULT_VOICE_PROFILES: Record<VoiceProfileKey, VoiceProfile> = {
  homeowner: {
    ...
    speechRate: 0.95,
    speechStyle: 'neutral_premium',
    interruptibilityMode: 'immediate',
    prosodyProfile: { warmth: 0.7, energy: 0.5, formality: 0.5, quebecFlavorLevel: 0, neutralAccentEnabled: true },
  },
  entrepreneur: {
    ...
    voiceNameSecondary: null,
    speechRate: 0.97,
    speechStyle: 'neutral_premium_direct',
    interruptibilityMode: 'immediate',
    prosodyProfile: { warmth: 0.5, energy: 0.7, formality: 0.5, quebecFlavorLevel: 0, neutralAccentEnabled: true },
  },
  condo_manager: {
    ...
    voiceNameSecondary: null,
    speechRate: 0.93,
    speechStyle: 'neutral_premium_structured',
    interruptibilityMode: 'sentence_end',
    prosodyProfile: { warmth: 0.4, energy: 0.4, formality: 0.7, quebecFlavorLevel: 0, neutralAccentEnabled: true },
  },
};
