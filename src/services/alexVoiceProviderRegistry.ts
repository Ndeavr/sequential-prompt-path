...
export const DEFAULT_VOICE_PROFILES: Record<VoiceProfileKey, VoiceProfile> = {
  homeowner: {
    ...
    prosodyProfile: { warmth: 0.7, energy: 0.5, formality: 0.5, quebecFlavorLevel: 1, neutralAccentEnabled: true },
  },
  entrepreneur: {
    ...
    interruptibilityMode: 'immediate',
    prosodyProfile: { warmth: 0.5, energy: 0.7, formality: 0.5, quebecFlavorLevel: 1, neutralAccentEnabled: true },
  },
  condo_manager: {
    ...
    prosodyProfile: { warmth: 0.4, energy: 0.4, formality: 0.7, quebecFlavorLevel: 1, neutralAccentEnabled: true },
  },
};
