...
export const FALLBACK_RULES: ContentRule[] = [
  ...
  { pattern: "se souvenir de tout", matchType: "plain", severity: "block", category: "jargon", description: "Legacy positioning — use Passeport Maison" },
  { pattern: "maison qui n'oublie", matchType: "plain", severity: "block", category: "jargon", description: "Legacy positioning — use Passeport Maison" },
  { pattern: "home memory", matchType: "plain", severity: "block", category: "jargon", description: "Legacy positioning — use home passport" },
  { pattern: "remember everything", matchType: "plain", severity: "block", category: "jargon", description: "Legacy positioning — use home passport" },
  ...
  { pattern: "dominer votre territoire", matchType: "plain", severity: "block", category: "jargon", description: "Langage excessif — dire « développer votre présence »" },
