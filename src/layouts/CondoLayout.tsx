/**
 * UNPRO Condos — Premium Condo Dashboard Layout
 */
...
const navItems = [
  { to: "/condos/dashboard", label: "Tableau de bord", icon: LayoutDashboard },
  { to: "/condos/building", label: "Profil immeuble", icon: Building2 },
  { to: "/condos/components", label: "Composantes", icon: Puzzle },
  { to: "/condos/maintenance", label: "Entretien", icon: Wrench },
  { to: "/condos/documents", label: "Documents", icon: FolderOpen },
  { to: "/condos/reserve-fund", label: "Fonds de prévoyance", icon: PiggyBank },
  { to: "/condos/quotes", label: "Soumissions", icon: Receipt },
  { to: "/condos/reports", label: "Rapports", icon: FileBarChart },
  { to: "/condos/billing", label: "Facturation", icon: Settings },
];
    ...
    <div className="min-h-screen flex bg-background">
      ...
      <aside className="hidden lg:flex w-60 flex-col border-r border-border/30 bg-card/40 backdrop-blur-sm">
        <Link to="/condos" className="flex items-center gap-2.5 px-5 py-5 border-b border-border/20">
          <div className="h-8 w-8 rounded-xl bg-gradient-to-br from-primary to-secondary flex items-center justify-center shadow-glow">
